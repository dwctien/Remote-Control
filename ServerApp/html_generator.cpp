...
html << R"(
    ...
    <div class="outer-container">
        ...
        <div class="inner-container">
            <p class="app__greeting">Greetings from <span style="font-weight: bold;">our team</span> - 23CTT2, University of Science, VNU-HCM.</p>
            <p class="app__desc">This is our project for <span style="font-weight: bold;">Computer Networking</span> Course (CSC10008).</p>
